...
# Apply Tomek Links TWICE for undersampling
# Check class distribution
table(train.labels)

tomek.results = ubTomek(train, train.labels)
train = tomek.results$X
train.labels= tomek.results$Y
...
write.table(output, file="submission-17.csv", quote=FALSE, sep=",", row.names=FALSE)
